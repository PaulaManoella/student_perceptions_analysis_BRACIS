...
def run_pipeline() -> None:
    ...
    for model_name in models_to_run:
        ...
        if model_name == 'lsa':
            ...
            df_lsa_topics.to_pickle('src/tmp/df_lsa_topics.pkl')
         ...
         # Start LDA model
            ...
            df_lda_topics.to_pickle('src/tmp/df_lda_topics.pkl')
         ...
         # Start NMF model
            ...
            df_nmf_topics.to_pickle('src/tmp/df_nmf_topics.pkl')
         ...
         # Start BERTopic model
            ...
            # ADICIONE ESTA LINHA PARA ATUALIZAR O MODELO PARA O MUNDO REAL:
            # b_model.update_topics(df_bertopic["comentario"], topics=new_topics)
            ...
            df_bertopic_results.to_pickle('src/tmp/df_bertopic_topics.pkl')
    ...
    pd.to_pickle(assignments_only, 'src/tmp/all_topic_assignments.pkl')
